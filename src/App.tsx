...
import { ItemSuggestion } from "./componets/ItemSuggestion"
...
function App() {
  ...
  async function handleSubmitChat() {
    ...
    if (progress === 'pending') {
      ...
      const prompt = `Gere uma pergunta onde simule uma entrevista de emprego sobre ${message}, após gerar a pergunta, enviarei a resposta e você me dará um feedback. O feedback precisa ser simples e objetivo e corresponder fielmente a resposta enviada.Após o feedback não existirá mais interação.`
      ...
      <div className="content">
        {progress === 'pending' && (
          <div className="box-home">
            ...
            <p>
              Estou aqui para te ajudar nos seus estudos. Selecione um dos tópicos sugeridos ao ladoou digite um tópico que deseja estudar paracomeçarmos
            </p>
          </div>
        )}
